...
- `npm run deploy` — fazer deploy no Vercel em modo de produção
...
Veja a documentação do Next.js para detalhes de deploy: https://nextjs.org/docs/app/building-your-application/deploying
...
GitHub: https://github.com/danvitoriano
